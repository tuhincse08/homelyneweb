...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dm->modeOfPayment = $request->modeOfPayment;
        $dm->paymentDetails = $request->paymentDetails;
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_man->modeOfPayment = $request->modeOfPayment;
        $delivery_man->paymentDetails = $request->paymentDetails;

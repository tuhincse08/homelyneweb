...
class POSController extends Controller
{
    ...
    public function place_order(Request $request)
    {
        ...
        if(!($request->amount >= ($total_price + $total_tax_amount + $order->delivery_charge))){
            $cart['paid'] = $total_price + $total_tax_amount + $order->delivery_charge;
            Toastr::error(translate('messages.paid_amount_is_less_than_total_amount'));
            return back();
        }

...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::get('forgetpass', 'LoginController@fgpass')->name('fgpass');
        Route::post('forgetpass', 'LoginController@fgpass_submit');
        
        Route::get('resetpassword/{token?}', 'LoginController@reset_pass')->name('resetpass');
        Route::post('resetpassword', 'LoginController@new_pass');

...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('forgetpass', 'PasswordResetController@fgpass_request');
        Route::post('check-token', 'PasswordResetController@check_token');
        Route::put('resetpassword', 'PasswordResetController@new_pass');
        
        // USER: email forget password
        Route::post('user-forgetpass', 'PasswordResetController@user_fgpass_request');
        Route::post('user-check-token', 'PasswordResetController@user_check_token');
        Route::put('user-resetpassword', 'PasswordResetController@new_pass');
        
        //SELLER: email forget Password
        Route::post('seller-forgetpass', 'PasswordResetController@seller_fgpass_request');
        
        //DeliverMan: email forget Password
        Route::post('delivery-forgetpass', 'PasswordResetController@delivery_fgpass_request');
        
        Route::get('searchtag', 'PasswordResetController@searchtag');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        ...
        Route::group(['prefix' => 'items'], function () {
            ...
            Route::get('searchtag', 'ItemController@searchtag');
        ...
        Route::group(['prefix' => 'categories'], function () {
            Route::get('/', 'CategoryController@get_categories');
            Route::get('searchtag', 'CategoryController@get_searchtag');
            Route::get('childes/{category_id}', 'CategoryController@get_childes');

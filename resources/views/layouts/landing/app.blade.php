        ...
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                ...
                <img class="img-fluid w-100 logo"
                    ...
                    src="{{ asset('storage/app/public/business/logorev3.png') }}" alt="HomeLyne">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    @if ($landing_page_links['web_app_url_status'])
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ $landing_page_links['web_app_url'] }}">Shop Now</a>
                        </li>
                    @endif
                    <!--li class="nav-item">
                        <a class="nav-link"
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="{{ route('restaurant.create') }}">Become A Seller</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="{{ route('deliveryman.create') }}">Become A Delivery Rider</a>
                    </li>
                    @endif
                    <!--li class="nav-item">
                        <a class="nav-link"

            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-2">
                    ...
                    <div class="mb-4">
                        ...
                        <a class="btn btn--primary w-100 {{ $order['order_status'] == 'accepted' ? '' : 'd-none' }}"
                            onclick="route_alert('{{ route('vendor.order.status', ['id' => $order['id'], 'order_status' => 'processing']) }}','{{ translate('messages.proceed_for_processing') }}')"
                            href="javascript:">{{ translate('messages.proceed_for_processing') }}</a>
                    ...
                    @if($order['order_type']!='take_away')
                        ...
                        @if($order->delivery_man)
                             <h5><span class="card-header-icon"><i class="tio-user"></i></span>
                               {{ translate('messages.deliveryman') }}</h5>

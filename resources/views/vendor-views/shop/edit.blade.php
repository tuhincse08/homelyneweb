                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" name="address" value="" class="form-control" id="address"
                            ...
                            <div class="row">       
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" name="returnaddress" class="form-control"
                                            placeholder="Retrun Address to receive return Orders"
                                            required>{{$shop->returnaddress}}</textarea>
                                </div> </div> 
                            </div> 
                            <div class="row">     
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="4" name="about" value="" class="form-control" id="about"
                                                required>{{$shop->footer_text}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

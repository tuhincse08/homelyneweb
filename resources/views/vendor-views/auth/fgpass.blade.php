...
<head>
    ...
    <!-- Title -->
    <title>{{'Store'}} | {{'Forget Password'}}</title>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                <!-- Form -->
                <form action="{{route('vendor.auth.fgpass')}}" method="post" id="fgpass">
                    ...
                    <div class="js-form-message form-group">
                        <label class="input-label text-capitalize" id="mailLabel" for="signinSrEmail">{{translate('messages.your')}} {{translate('messages.email')}}</label>
                    ...
                    <button type="submit" id="mailSubmit" class="btn btn-lg btn-block btn--primary mt-xxl-3"> Send Reset Link </button>
                </form>
                <!-- End Form -->
...
<script>
    $(document).on('submit' , '#fgpass', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: "https://admin.ghwo.org/api/v1/auth/seller-forgetpass", // form action url
            data: $(this).serialize(),
         ...
         error: function(error) {
          ...
          document.getElementById('ajax_report').innerHTML = 'Email not Found';

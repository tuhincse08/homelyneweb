                            ...
                            <ul class="nav nav-pills mb-3 custom-nav-tab" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-vegetables" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">Vegetables & Fruit <img src="{{ asset('assets/front/svg/1/vegetable.svg')}}"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-beverages" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/cup.svg')}}" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-meat" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false">Meats & Seafood <img src="{{ asset('assets/front/svg/1/meats.svg')}}"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-dairy" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/breakfast.svg')}}" class="blur-up lazyload"
                                            alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-frozen" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/frozen.svg')}}" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-snack" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/biscuit.svg')}}" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-grocery" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/grocery.svg')}}" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-wines" data-bs-toggle="pill"
                                            ...
                                            src="{{ asset('assets/front/svg/1/drink.svg')}}" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-milk" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false">Milk & Dairies <img src="{{ asset('assets/front/svg/1/milk.svg')}}" alt=""
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-pet" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false">Pet Foods <img class="blur-up lazyload"
                                                                                 src="{{ asset('assets/front/svg/1/pet.svg')}}" alt=""></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <ul>
                                    <li class="three-grid">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('assets/front/svg/grid-3.svg')}}" class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                    <li class="grid-btn d-xxl-inline-block d-none active">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('assets/front/svg/grid-4.svg')}}"
                                                 class="blur-up lazyload d-lg-inline-block d-none" alt="">
                                            <img src="{{ asset('assets/front/svg/grid.svg')}}"
                                                 class="blur-up lazyload img-fluid d-lg-none d-inline-block" alt="">
                                        </a>
                                    </li>
                                    <li class="list-btn">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('assets/front/svg/list.svg')}}" class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>

                        ...
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/1.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/2.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/3.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/4.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/5.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/6.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="shop-left-sidebar.html" class="seller-grid-box">
                        <div class="grid-contain">
                            ...
                            <div class="contain-name">
                                ...
                                <div class="grid-image">
                                    <img src="{{ asset('assets/front/images/vendor-page/logo/7.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </a>

                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/1.jpg')}}" id="img-1"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/1.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/2.jpg')}}"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/2.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/3.jpg')}}"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/3.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/4.jpg')}}"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/4.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/5.jpg')}}"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/5.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('assets/front/images/product/category/6.jpg')}}"
                                                         data-zoom-image="{{ asset('assets/front/images/product/category/6.jpg')}}"
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('assets/front/images/product/payment/1.svg')}}"
                                                     class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('assets/front/images/product/payment/2.svg')}}"
                                                     class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('assets/front/images/product/payment/3.svg')}}"
                                                     class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('assets/front/images/product/payment/4.svg')}}"
                                                     class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('assets/front/images/product/payment/5.svg')}}"
                                                     class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
                                                        ...
                                                        <ul class="review-list">
                                                                ...
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('assets/front/images/review/1.jpg')}}"
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('assets/front/images/review/2.jpg')}}"
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 alt="">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('assets/front/images/review/3.jpg')}}"
                                                                                 class="img-fluid blur-up lazyload"
                                                                                 alt="">
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="vendor-box">
                            <div class="verndor-contain">
                                <div class="vendor-image">
                                    <img src="{{ asset('assets/front/images/product/vendor.png')}}" class="blur-up lazyload" alt="">
                                </div>

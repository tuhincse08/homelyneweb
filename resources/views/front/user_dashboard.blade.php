                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/front/images/inner-page/user/1.jpg') }}"
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('assets/front/images/svg/order.svg') }}"
                                                         class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('assets/front/images/svg/order.svg') }}" class="blur-up lazyload"
                                                         alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('assets/front/images/svg/pending.svg') }}"
                                                         class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('assets/front/images/svg/pending.svg') }}" class="blur-up lazyload"
                                                         alt="">
                                                    <div class="totle-detail">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('assets/front/images/svg/wishlist.svg') }}"
                                                         class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('assets/front/images/svg/wishlist.svg') }}"
                                ...
                                <div class="dashboard-order">
                                    ...
                                    <div class="order-contain">
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="{{ asset('assets/front/images/vegetable/product/2.png') }}" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="{{ asset('assets/front/images/vegetable/product/3.png') }}" alt=""
                                                         class="blur-up lazyload">
                                                </a>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('assets/front/images/payment-icon/1.jpg') }}"
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details card-visa">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('assets/front/images/payment-icon/2.jpg') }}"
                                                                 class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details dabit-card">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('assets/front/images/payment-icon/3.jpg') }}"
                                                                 class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="{{ asset('assets/front/images/inner-page/dashboard-profile.png') }}"
                                                         class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                        </div>

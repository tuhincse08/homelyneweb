...
@section('content')
            ...
            <div class="row g-4">
                <div class="col-xxl-6 col-md-8">
                    <div class="home-contain h-100">
                        <img src="{{ asset('assets/front/images/veg-3/home/1.png')}}" class="img-fluid bg-img blur-up lazyload" alt="">
                ...
                <div class="col-xxl-3 col-md-4 ratio_medium d-md-block d-none">
                    <div class="home-contain home-small h-100">
                        <div class="h-100">
                            <img src="{{ asset('assets/front/images/veg-3/home/2.png')}}" class="img-fluid bg-img blur-up lazyload"
                                 alt="">
                        </div>
                ...
                <div class="col-xxl-3 ratio_65 d-xxl-block d-none">
                    <div class="row g-3">
                        <div class="col-xxl-12 col-sm-6">
                            <div class="home-contain">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('assets/front/images/veg-3/home/3.png')}}"
                        ...
                        <div class="col-xxl-12 col-sm-6">
                            <div class="home-contain">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('assets/front/images/veg-3/home/4.png')}}"
                                         class="img-fluid bg-img blur-up lazyload" alt="">
                                </a>
                    ...
                    <div class="category-slider arrow-slider">
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn">
                                <a href="shop-left-sidebar.html" class="circle-1">
                                    <img src="{{ asset('assets/front/images/veg-3/category/1.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.05s">
                                <a href="shop-left-sidebar.html" class="circle-2">
                                    <img src="{{ asset('assets/front/images/veg-3/category/2.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.1s">
                                <a href="shop-left-sidebar.html" class="circle-3">
                                    <img src="{{ asset('assets/front/images/veg-3/category/3.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Food Cupboard</h6>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.15s">
                                <a href="shop-left-sidebar.html" class="circle-4">
                                    <img src="{{ asset('assets/front/images/veg-3/category/4.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Dals & Pulses</h6>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.2s">
                                <a href="shop-left-sidebar.html" class="circle-4">
                                    <img src="{{ asset('assets/front/images/veg-3/category/5.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.25s">
                                <a href="shop-left-sidebar.html" class="circle-1">
                                    <img src="{{ asset('assets/front/images/veg-3/category/6.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.3s">
                                <a href="shop-left-sidebar.html" class="circle-2">
                                    <img src="{{ asset('assets/front/images/veg-3/category/7.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.35s">
                                <a href="shop-left-sidebar.html" class="circle-3">
                                    <img src="{{ asset('assets/front/images/veg-3/category/8.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Instant Mixes</h6>
                    ...
                    <div class="three-slider arrow-slider ratio_65">
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="{{ asset('assets/front/images/veg-3/value/1.png')}}" class="img-fluid bg-img blur-up lazyload"
                                     alt="">
                        ...
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="{{ asset('assets/front/images/veg-3/value/2.png')}}" class="img-fluid bg-img blur-up lazyload"
                                     alt="">
                                <div class="banner-detail">
                        ...
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="{{ asset('assets/front/images/veg-3/value/3.png')}}" class="img-fluid bg-img blur-up lazyload"
                                     alt="">
                                <div class="banner-detail">
                    ...
                    <div class="three-slider-1 arrow-slider">
                        <div>
                            <div class="deal-box wow fadeInUp">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="{{ asset('assets/front/images/veg-3/cate1/1.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.05s">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="{{ asset('assets/front/images/veg-3/cate1/2.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.1s">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="{{ asset('assets/front/images/veg-3/cate1/3.png')}}" class="img-fluid blur-up lazyload"
                                         alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.15s">
                                <div class="category-image order-sm-2">
                                    <img src="{{ asset('assets/front/images/veg-3/cate1/1.png')}}" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/3.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/5.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/6.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/7.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/9.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/11.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/12.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/13.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.45s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/15.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/17.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.55s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/18.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/2.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/4.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/10.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/8.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/14.png')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('assets/front/images/veg-3/cate1/16.png')}}" class="img-fluid" alt="">
                                    </a>
            ...
            <div class="row gy-xl-0 gy-3">
                <div class="col-xl-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="{{ asset('assets/front/images/veg-3/banner/1.png')}}" class="bg-img img-fluid" alt="">
                        <div
                ...
                <div class="col-xl-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="{{ asset('assets/front/images/veg-3/banner/2.png')}}" class="bg-img img-fluid" alt="">
                                    ...
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/1.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/2.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/3.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/4.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/5.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/6.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/7.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/8.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 pb-1 wow fadeInUp" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/9.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/10.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/11.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('assets/front/images/veg-3/pro1/12.png')}}" class="img-fluid"
                                                         alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-contain-3 section-b-space section-t-space hover-effect">
                        <img src="{{ asset('assets/front/images/veg-3/banner/3.png')}}" class="img-fluid bg-img" alt="">
            ...
            <div class="slider-3 arrow-slider">
                    ...
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="{{ asset('assets/front/images/veg-3/blog/1.jpg')}}" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="{{ asset('assets/front/images/veg-3/blog/2.jpg')}}" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="{{ asset('assets/front/images/veg-3/blog/3.jpg')}}" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
    ...
    <section class="newsletter-section-2 section-b-space">
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                    <div class="newsletter-box hover-effect bg-size" style="background-image: url(&quot;../assets/images/veg-3/shape/background.png&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                        <img src="{{ asset('assets/front/images/veg-3/shape/background.png') }}" class="img-fluid bg-img" alt="" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-xl-5 d-xl-block d-none">
                                <div class="shape-box">
                                    <img src="{{ asset('assets/front/images/veg-3/shape/basket.png') }}" alt="" class="img-fluid image-1">
                                </div>
                            </div>
                        </div>
                    </div>

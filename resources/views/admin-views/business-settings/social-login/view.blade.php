                            ...
                            <div class="card-body text-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                                ...
                                <form
                                    ...
                                    <div class="form-group mb-2 mt-5">
                                        ...
                                        <label class="{{Session::get('direction') === "rtl" ? 'pr-10' : 'pl-10'}}">{{translate('messages.active')}}</label>
                                        <br>
                                    </div>
                                    <div class="form-group mb-2">
                                        <input type="radio" name="status"
                                               value="0" {{$socialLoginService['status']==0?'checked':''}}>
                                        <label class="{{Session::get('direction') === "rtl" ? 'pr-10' : 'pl-10'}}">{{translate('messages.inactive')}}</label>
                                        <br>
                                    </div>
                                    <div class="form-group mb-2">
                                        <label class="{{Session::get('direction') === "rtl" ? 'pr-10' : 'pl-10'}}">{{translate('messages.callback_uri')}}</label>
                                    ...
                                    <div class="form-group mb-2">
                                        <label
                                            class="{{Session::get('direction') === "rtl" ? 'pr-10' : 'pl-10'}}">{{translate('messages.store_client_id')}}</label><br>
                                        <input type="text" class="form-control" name="client_id"
                                               value="{{ $socialLoginService['client_id'] }}">
                                    </div>
                                    <div class="form-group mb-2">
                                        <label
                                            class="{{Session::get('direction') === "rtl" ? 'pr-10' : 'pl-10'}}">{{translate('messages.store_client_secret')}}</label><br>

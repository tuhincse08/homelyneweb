                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="returnaddress" class="form-control"
                                            ...
                                            required>{{$store->returnaddress}}</textarea>
                                </div>
                                </div>
                            </div>
                            <div class="row g-3 my-0">
                                <div class="col-lg-12 col-sm-12">
                                     <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" name="about" class="form-control" rows="4" placeholder="About Store" required >{{$store->footer_text}}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            <option
                                                value="passport" {{$store->vendor->identity_type == 'passport'?'selected':''}}>
                                                {{translate('messages.passport')}}
                                            </option>
                                            <option
                                                value="driving_license" {{$store->vendor->identity_type =='driving_license'?'selected':''}}>
                                                {{translate('messages.driving')}} {{translate('messages.license')}}
                                            </option>
                                            <option value="others" {{$store->vendor->identity_type =='others'?'selected':''}}>Others
                                            </option>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="identity_number" value="{{$store->vendor->identity_number}}"
                                                class="form-control"
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="row g-2">
                                        ...
                                        @if($store->vendor->identity_image)
                                        @foreach(json_decode($store->vendor->identity_image,true) as $img)
                                        <div class="col-6 spartan_item_wrapper size--sm">
                                            <img class="rounded border" src="{{asset('storage/app/public/vendor').'/'.$img}}">
                                        </div>
                                        @endforeach
                                        @endif
                                    </div>

                            ...
                            <div class="row g-3 my-0">
                                <div class="col-lg-12 col-sm-12">
                                     <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" name="about" class="form-control" rows="4" placeholder="About Store" required >{{old('about')}}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="f_name">{{translate('messages.first')}} & Middle {{translate('messages.name')}}</label>
                                        <input type="text" name="f_name" class="form-control" placeholder="{{translate('messages.first')}} & Middle {{translate('messages.name')}}"

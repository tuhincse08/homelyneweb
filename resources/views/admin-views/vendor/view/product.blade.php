        ...
        <div class="tab-pane fade show active" id="product">
            ...
            <div class="resturant-card-navbar px-xl-4 justify-content-evenly">
                <div class="order-info-item">
                    ...
                    @php($item = \App\Models\item::where(['store_id'=>$store->id])->count())
                ...
                <img src="{{asset('/public/assets/admin/img/active.png')}}" alt="public">
                    ...
                    @php($item = \App\Models\item::where(['store_id'=>$store->id, 'status'=>1])->count())
                    @php($item = ($item == null) ? 0 : $item)
                    <h6 class="card-subtitle">
                ...
                <img src="{{asset('/public/assets/admin/img/inactive.png')}}" alt="public">
                    ...
                    @php($item = \App\Models\item::where(['store_id'=>$store->id, 'status'=>0])->count())
                    @php($item = ($item == null) ? 0 : $item)
                    <h6 class="card-subtitle">
...
@push('script_2')
    ...
    <script>
        ...
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('admin.item.vendor-search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,

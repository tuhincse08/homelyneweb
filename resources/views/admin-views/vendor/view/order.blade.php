                        ...
                        <div class="search--button-wrapper">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item" href="{{route('admin.order.vendor-export', ['type'=>'excel', 'store_id'=>$store->id])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                            src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                            alt="Image Description">
                                        {{ translate('messages.excel') }}
                                    </a>
                                    <a id="export-csv" class="dropdown-item" href="{{route('admin.order.vendor-export', ['type'=>'csv', 'store_id'=>$store->id])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
...
@push('script_2')
    ...
    <script>
        $(document).on('ready', function () {
            ...
            $.post({
                url: '{{route('admin.order.vendor-search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,

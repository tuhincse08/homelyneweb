                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="f_name" class="form-control" placeholder="{{translate('messages.first')}} & Middle {{translate('messages.name')}}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="modeOfPayment" class="form-control">
                                            ...
                                            <option value="2">Bank Card(Credit/Debit)</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="paymentDetails" row="2" class="form-control"
                                        placeholder="Account Details"> {{ old('paymentDetails') }} </textarea>
                                </div>

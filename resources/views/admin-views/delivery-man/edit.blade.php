                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.first')}} & Middle {{translate('messages.name')}}</label>
                                        <input type="text" value="{{$delivery_man['f_name']}}" name="f_name"
                                                class="form-control" placeholder="{{translate('messages.first')}} & Middle {{translate('messages.name')}}"
                                                required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option value="others" {{$delivery_man['identity_type']=='others'?'selected':''}}>Others
                                            </option>
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="modeOfPaymentInput">Mode of Payment</label>
                                        <select name="modeOfPayment" class="form-control">
                                            <option value="1" {{$delivery_man['modeOfPayment']=='1'?'selected':''}}>Bank Account</option>
                                            <option value="2" {{$delivery_man['modeOfPayment']=='2'?'selected':''}}>Bank Card(Credit/Debit)</option>
                                            <option value="3" {{$delivery_man['modeOfPayment']=='3'?'selected':''}}>GCash</option>
                                            <option value="4" {{$delivery_man['modeOfPayment']=='4'?'selected':''}}>Others</option>
                                        </select>
                                    </div>
                                
                                <div class="form-group">
                                    <label class="input-label"
                                        for="paymentDetailsInput">Payment Details</label>
                                    <textarea type="text" name="paymentDetails" row="2" class="form-control"
                                        placeholder="Account Details"> {{ $delivery_man['paymentDetails'] }} </textarea>
                                </div>

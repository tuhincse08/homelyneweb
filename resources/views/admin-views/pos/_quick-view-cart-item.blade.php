            ...
            <form id="add-to-cart-form" class="mb-2">
                ...
                @foreach (\App\Models\AddOn::whereIn('id', $add_ons)->active()->get() as $key => $add_on)
                    <div class="flex-column pb-2">
                        ...
                        <label class="input-group addon-quantity-input mx-1 shadow bg-white rounded px-1 @if(in_array( $add_on->id, $cart_item['add_ons'])) visibility-visible @endif" for="addon{{ $key }}">

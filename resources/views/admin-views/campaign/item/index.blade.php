                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="store_id" class="js-data-example-ajax form-control" id="store_id" onchange="getStoreData('{{url('/')}}/admin/vendor/get-addons?data[]=0&store_id='+this.value,'add_on')"  data-toggle="tooltip" data-placement="right" data-original-title="Select Store" required>

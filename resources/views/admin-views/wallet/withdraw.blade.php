                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('admin.vendor.withdraw_export', ['type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                    alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{route('admin.vendor.withdraw_export', ['type'=>'csv',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
...
@push('script_2')
    <script>
        ...
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('admin.vendor.withdraw_search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
